            ...
            <div class="navbar-nav d-flex justify-content-center align-items-center">
                <template v-if="$store.state.user.isAuthenticated">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                          <router-link class="nav-link active" aria-current="page" to="CrearGrupo">Crear Grupo</router-link>
                        </li>
                        <li class="nav-item">
                          <router-link class="nav-link active" aria-current="page" to="ListaGrupos">Ver Grupos</router-link>
                        </li>
                        <li class="nav-item">
